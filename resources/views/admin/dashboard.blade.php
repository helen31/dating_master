    ...
    <div class="col-md-3">
        <section class="panel">
            ...
            <div class="panel-body" style="display: block;">
                ...
                <p ><a href="{{ url(App::getLocale().'/admin/girls/onmoderation') }}" class="text-info"><strong>{{ trans('admin/control.moderation') }}:</strong><span class="label label-info pull-right">{{ isset($moderation) ? sizeof($moderation): 0 }}</span></a></p>
        ...
        @if(Auth::user()->hasRole('Owner') || Auth::user()->hasRole('Moder'))
            <section class="panel">
                ...
                <div class="panel-body" style="display: block;">
                    ...
                    <p ><a href="{{ url(App::getLocale().'/admin/man/onmoderation') }}" class="text-info"><strong>{{ trans('admin/control.moderation') }}:</strong><span class="label label-info pull-right">{{ isset($m_moderation) ? sizeof($m_moderation): 0 }}</span></a></p>
