        ...
        <div class="panel-body">
            ...
            <form class="form-inline" method="POST" action="{{ action('Admin\ClientFinanceController@getDeposits') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="datepicker-finances-startDate3" name="start_date" type="datetime" class="form-control" value="{{ $start_date }}">
                </div>
                <div class="form-group">
                    <label>Конец периода</label>
                    <input id="datepicker-finances-endDate3" type="datetime" class="form-control" value="{{ $end_date }}">
                </div>
