    ...
    <section class="panel">
        <div class="panel-body">
            ...
            <li class="list-group-item list-group-item-info text-center">
                *Целая и дробная часть числа (сумма начисления) должны разделятся точкой (пример: 3.50), иначе данные не сохранятся
            </li>
            <hr>
            <div class="col-md-12">
                {!! Form::open(['action' => ['Admin\ClientFinanceController@saveRefund', $user->id]]) !!}
                <div class="form-group">
                    {!! Form::label('amount', 'Сумма начисления / возврата (Love Coins)') !!}
                ...
                <div class="form-group">
                    {!! Form::submit('Начислить Love Coins', ['class' => 'btn btn-success']) !!}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
