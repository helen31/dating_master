...
@section('content')
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            @endif
            {!! Form::open(['url' => '/admin/sender/store', 'class' => 'form', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            <div class="col-md-12">
                {{ Form::hidden('girl_id', $girl_id) }}
                ...
                <div class="form-group col-md-12">
                    ...
                    {!! Form::textarea('textarea', 'body', null, ['class'=>'form-control']) !!}
                </div>
