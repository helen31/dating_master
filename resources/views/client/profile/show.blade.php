                        ...
                        <div class="col-md-6">
                            <div class="row girl-action">
                                ...
                                @if(Auth::user()->hasRole('Male'))
                                    ...
                                    <a href="{{ url('/'. App::getLocale() . '/profile/'. Auth::user()->id . '/contacts/'.$u->uid) }}"><img src="/assets/img/contacts.png" alt="Gifts" title="{{ trans('profile.request_contacts') }}" height="64px"></a>
                                @endif
                            </div>
                        </div>
                    </div>
