...
@section('profileContent')
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            @endif
                {!! Form::open(['url' =>url('/'.App::getLocale().'/profile/'.$id.'/edit_album/'.$album->id), 'class' => 'form', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::file('cover_image', ['class' => 'file','id'=>'cover_image', 'accept' => 'image/*', 'data-show-upload' => 'false', 'data-show-caption' => 'true'],'uploads/albums/'.$album->cover_image) !!}
                </div>
                <div class="form-group">
                ...
                <div class="btn col-md-12">
                    <a style="width: 100%" class="btn btn-lg btn-success" href="{{url('/'.App::getLocale().'/profile/'.Auth::user()->id) }}">{{ trans('albums.btn-back') }}</a>
                </div>
                <!-- The Modal -->
...
@section('scripts')
    ...
    <script>
        ...
        function deleteFoto(event,foID){
            ...
            $.post( "/profile/dropImageAlbum/"+foID, {_token : $('input[name="_token').val()} ).done( function( data ) {
                $("#photo-"+foID).remove();
            });
        }
    </script>
